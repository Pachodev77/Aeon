    ...
    <div className="relative w-full max-w-sm aspect-[9/16] mx-auto flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="relative w-full h-full flex flex-col items-center justify-center px-6">
        <div className="absolute inset-0" style={{ transform: 'translateY(69px)' }}>
          ...
          <button className="absolute top-[64%] left-1/2 -translate-x-1/2 text-green-500 hover:text-green-400 transition-colors opacity-70 hover:opacity-100 flex items-start justify-center" style={{ transform: 'translateX(-120px) translateY(8px)' }}>
            <Shuffle size={16} />
          </button>

          <button className="absolute top-[64%] left-1/2 -translate-x-1/2 text-green-500 hover:text-green-400 transition-colors opacity-70 hover:opacity-100 flex items-start justify-center" style={{ transform: 'translateX(-80px) translateY(8px)' }}>
          ...
          <button
            ...
            className="absolute top-[64%] left-1/2 -translate-x-1/2 w-12 h-12 rounded-full bg-black flex items-center justify-center text-green-500 hover:bg-gray-900 transition-all hover:scale-105"
          >
            {isPlaying ? <Pause size={24} fill="currentColor" /> : <Play size={24} fill="currentColor" className="ml-0.5" />}
          </button>

          <button className="absolute top-[64%] left-1/2 -translate-x-1/2 text-green-500 hover:text-green-400 transition-colors opacity-70 hover:opacity-100 flex items-start justify-center" style={{ transform: 'translateX(62px) translateY(8px)' }}>
            <SkipForward size={18} fill="currentColor" />
          </button>

          <button
            onClick={() => setIsLiked(!isLiked)}
            className="absolute top-[64%] left-1/2 -translate-x-1/2 text-green-500 hover:text-green-400 transition-colors opacity-70 hover:opacity-100 flex items-start justify-center"
            style={{ transform: 'translateX(102px) translateY(8px)' }}
          >
            <Heart size={16} fill={isLiked ? "currentColor" : "none"} />
          </button>

          <div className="absolute top-[71%] left-1/2 -translate-x-1/2 flex items-center justify-center gap-20">
          ...
          <div className="absolute top-[77%] left-1/2 -translate-x-1/2 flex items-center justify-center gap-2">
